...
<header class="topo">
    ...
    <section class="fundo set-bg">
        <div class="box" style="float:none; margin:200px auto;">
            <div class="titulo"><strong>Adicionar Contato</strong></div>
            <div class="cadastro" style="margin: 0 0 0 0;">
                <form method="POST" style="margin: 10px 150px 50px 100px" action=<?php echo "adicionarContato.act.php?codCliente=". $_GET['codCliente']?>>
                    <table>
                        <tr><td>email:</td><td><input type="text" name="email"></td></tr>
                        <tr><td>telefone:</td><td><input type="text" name="tel"></td></tr>
                        <tr><td>celular:</td><td><input type="text" name="cel"></td></tr>
                        <tr><td><button type="submit" name="adicionar" class="botaoForm" style="margin-top:25px; margin-bottom:20px">Adicionar</button></td>
